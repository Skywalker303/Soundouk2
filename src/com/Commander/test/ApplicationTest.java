package com.Commander.test;

import com.Commander.FileAssist;
import com.Commander.StringAssist;
...
public class ApplicationTest {
    ...
    public void singleFileCopyToOtherDirectory() {
        try {
            ...
            FileAssist.copy(selection, mTargetDirectory.toPath());
    ...
    public void splitWordsTest() {
        ...
        String[] words = StringAssist.getWords(text);
    ...
    public void containsWordTest() {
        ...
        String word = "find";
        assertThat(StringAssist.containsWord(text, word), equalTo(true));
    }
